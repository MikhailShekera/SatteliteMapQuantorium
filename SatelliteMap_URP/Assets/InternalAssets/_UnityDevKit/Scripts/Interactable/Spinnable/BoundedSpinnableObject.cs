...
namespace UnityDevKit.Interactables.Spinnable
{
    public class BoundedSpinnableObject : SpinnableObject
    {
        ...
        [SerializeField] protected UnityEvent<Vector3> onSpinNotRoundedEvent;
        [SerializeField] protected UnityEvent<float, float> onMaxMinSet;
        ...
        {
            base.Start();
            _startRot = localAxis ? TransformData.localEulerAngles : TransformData.eulerAngles;
